<div class="modal" id="cylindre-m">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Ballon Solaire</h4>
...
function effacer_bal(){
  $('#cylindre-m select').prop('selectedIndex',0);
  $("#cylindre-m input").val('');
}
...
$('#cylindre-m form').on('submit', function(event){
  event.preventDefault();
  var fd=new FormData(this);
  $("#cylindre-m").css("cursor","wait");
  $.ajax({
      url: '/send_ballon/sys3',
      method:"POST",
      data:fd,
      contentType: false,
      processData: false,
