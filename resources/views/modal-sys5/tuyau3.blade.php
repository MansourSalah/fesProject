<div class="modal" id="tuyau3-m">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Tuyauterie Distribution Chauffage </h4>
...
$('#tuyau3-m form').on('submit', function(event){
        event.preventDefault();
        var fd=new FormData(this);
        $("#tuyau3-m").css("cursor","wait");
        $.ajax({
            url: '/send_tuyau3/sys5',
            method:"POST",
            data:fd,
            contentType: false,
            processData: false,
