  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <!-- Modal Header -->
        ...
        <form method="post" action="/graph/sys2">
            @csrf
            <div class="modal-body">
                <div class="row" style="padding: 10px;">
                    <div class="col-6" style="display: grid;">
                        ...
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph14">Pertes thermiques ballon
                        </label>
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph16">Economie d’énergie
                        </label>
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph18">Gain cumulé
                        </label>
                    </div>
                    <div class="col-6" style="display: grid;">
                        <label class="form-check-label">
                        ...
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph13">TCB'' 
                        </label>
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph15">Pertes thermiques tuyautrie
                        </label>
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="grph17">Consommation pompe
                        </label>
                    </div>
                </div>
                <hr>
