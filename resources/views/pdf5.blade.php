...
<h3 style="text-align: center;"><span style="color: #5656d8;">"CES à circulation forcée & chauffage"</span></h3>
...
<h3>3. CES à circulation forcée & chauffage</h3>
...
<table style="width:100%;" >
  ...
  <tr>
    <td>{{$mois[$i]}}</td>        
    <td style="color: #5656d8;width:17%;">{{$qucollM[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$qaux[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$pethe1[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$pethe2[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$fs[$i]}}</td>
  </tr>
  @endfor
...
<table style="width:100%;margin-top:10px" >
  ...
  <tr>
    <td>{{$mois[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$effcoll[$i]}}</td>        
    <td style="color: #5656d8;width:17%;">{{$ecollM[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$petu[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$ecen1[$i]}}</td>
    <td style="color: #5656d8;width:17%;">{{$conpom[$i]}}</td>
  </tr>
  @endfor
    <tr>
        <td></td>
...
<p><strong>Besoin eau chaude sanitaire : </strong></p>
<table style="width:100%;" >
  <tr>
    @for($i=0;$i<=11;$i++)
        <th>{{$mois[$i]}}</th>
  ...
  <tr>
    @for($i=0;$i<=11;$i++)
        <td style="color: #5656d8;">{{$betheP[$i]}}</td>
    @endfor
  </tr>
</table>
<p><strong>Besoin chauffage : </strong></p>
<table style="width:100%;" >
  <tr>
    @for($i=0;$i<=11;$i++)
        <th>{{$mois[$i]}}</th>
  ...
  <tr>
    @for($i=0;$i<=11;$i++)
        <td style="color: #5656d8;">{{$bechauf[$i]}}</td>
    @endfor
  </tr>
</table>

<p><strong>Besoin thermique total (Besoin eau chaude sanitaire + Besoin chauffage): </strong></p>
<table style="width:100%;" >
  <tr>
    @for($i=0;$i<=11;$i++)
        <th>{{$mois[$i]}}</th>
  ...
  <tr>
    @for($i=0;$i<=11;$i++)
        <td style="color: #5656d8;">{{$bethe[$i]}}</td>
    @endfor
    <td style="color:red;">{{$betheS}}</td>
  </tr>
</table>
