<div class="modal" id="cylindre1-m">
      ...
      <!-- Modal Header -->
        ...
        <form>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" step="0.0001" min="0.0001" name="pui" required>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="effacer_bal1()" >Effacer</button>
...
function effacer_bal1(){
  $('#cylindre1-m select').prop('selectedIndex',0);
  $("#cylindre1-m input").val('');
}
...
$('#cylindre1-m form').on('submit', function(event){
  event.preventDefault();
  var fd=new FormData(this);
  $("#cylindre1-m").css("cursor","wait");
  $.ajax({
      url: '/send_ballon1/sys4',
      method:"POST",
      data:fd,
      contentType: false,
      processData: false,
      ...
      success: function(data){
          $("#cylindre1-m").css("cursor","default");
          alert(data);
      }
  }); 
});
