...
<h3 style="text-align: center;"><span style="color: #5656d8;">"CES à circulation forcée & échangeur"</span></h3>
...
<h3>3. CES à circulation forcée & échangeur</h3>
...
<table style="width:100%;" >
  ...
  @for($i=0;$i<=11;$i++)
    <tr>
        ...
        <td style="color: #5656d8;width:14%;">{{$pethe[$i]}}</td>
