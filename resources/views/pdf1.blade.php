...
<h3 style="text-align: center;"><span style="color: #5656d8;">"Thermosiphon"</span></h3>
...
<h3>3. Thermosiphon</h3>
<p><strong>Volume du ballon : </strong><span style="color: #5656d8;">{{$vol}} L</span></p> 
<br>
...
<table style="width:100%;" >
  <tr>
    ...
    <th>Perte thermique</th>
  </tr>
  @for($i=0;$i<=11;$i++)
    <tr>
        <td>{{$mois[$i]}}</td>
        <td style="color: #5656d8;width:20%;">{{$bethe[$i]}}</td>        
        <td style="color: #5656d8;width:20%;">{{$qucollM[$i]}}</td>
        <td style="color: #5656d8;width:20%;">{{$qaux[$i]}}</td>
        <td style="color: #5656d8;width:20%;">{{$pethe[$i]}}</td>
    </tr>
  @endfor
    <tr>
        <td></td>
        ...
        <td style="color:red;">SUM = {{$petheS}}</td>
    </tr>
</table>
<br>
<table style="width:100%;margin-top:10px" >
  ...
  <tr>
    ...
    <td style="color: #5656d8;width:20%;">{{$ecen[$i]}}</td>
    <td style="color: #5656d8;width:20%;">{{$fs[$i]}}</td>
  </tr>
  @endfor
    <tr>
        <td></td>
        ...
        <td style="color:red;">SUM = {{$ecenS}}</td>
